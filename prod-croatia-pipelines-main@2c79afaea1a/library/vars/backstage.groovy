...
def call() {
  ...
  '''
    ...
    stages {
      ...
      stage('Build') {
        ...
        steps {
          ...
          buildah bud -t "artifactory.apps.prod-nonpci-shared.nrapp.cloud/docker-local/backstage:${IMAGE_TAG}" .
          buildah tag "artifactory.apps.prod-nonpci-shared.nrapp.cloud/docker-local/backstage:${IMAGE_TAG}" "artifactory.apps.prod-nonpci-shared.nrapp.cloud/docker-local/backstage:${IMAGE_TAG}-${SHORT_COMMIT}"
          buildah tag "artifactory.apps.prod-nonpci-shared.nrapp.cloud/docker-local/backstage:${IMAGE_TAG}" "artifactory.apps.prod-nonpci-shared.nrapp.cloud/docker-local/backstage:latest"
          buildah push "artifactory.apps.prod-nonpci-shared.nrapp.cloud/docker-local/backstage:${IMAGE_TAG}"
          buildah push "artifactory.apps.prod-nonpci-shared.nrapp.cloud/docker-local/backstage:${IMAGE_TAG}-${SHORT_COMMIT}"
          buildah push "artifactory.apps.prod-nonpci-shared.nrapp.cloud/docker-local/backstage:latest"
          """
        }
      }
    ...
    post {
      always {
        sh('buildah logout artifactory.apps.prod-nonpci-shared.nrapp.cloud')
      }
    }
  }
}
      ...
      scm {
        git {
          ...
          remote {
            ...
            name('origin')
            url("ssh://git@bitbucket.nrapp.cloud/MOB/croatia-mobile-app.git")
          }
          extensions {
            wipeOutWorkspace()
          }

        ...
        stages {
          ...
          stage('Package') {
            ...
            steps {
              ...
              buildah bud -t "artifactory.apps.dev-nonpci-shared.npnbank.local/docker-local/${NAME}:${IMAGE_TAG}" .
              buildah tag "artifactory.apps.dev-nonpci-shared.npnbank.local/docker-local/${NAME}:${IMAGE_TAG}" "artifactory.apps.dev-nonpci-shared.npnbank.local/docker-local/${NAME}:${IMAGE_TAG}-${SHORT_COMMIT}"
              buildah push "artifactory.apps.dev-nonpci-shared.npnbank.local/docker-local/${NAME}:${IMAGE_TAG}"
              buildah push "artifactory.apps.dev-nonpci-shared.npnbank.local/docker-local/${NAME}:${IMAGE_TAG}-${SHORT_COMMIT}"
              '''
            }
          }
